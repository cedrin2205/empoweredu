...
<html lang="en">
  ...
  <body>
        ...
        <section>
            ...
            <div class="contain">
                <form action="GAS12uploadhands1.php" method="post" enctype="multipart/form-data">
            ...
            <div class="gallery">
                ...
                include "gasdb12.php";
                $limit = 5; 
                $sql = "SELECT * FROM gas12hands1 ORDER BY id DESC LIMIT $limit";
                $res = mysqli_query($conn, $sql);

                if (mysqli_num_rows($res) > 0) {
                    while ($gas12hands1 = mysqli_fetch_assoc($res)) { ?>
                        <div class="alb">
                            <?php 
                            $fileExtension = pathinfo($gas12hands1['image_url'], PATHINFO_EXTENSION);
                            if ($fileExtension === 'pdf') {
                                echo '<img src="img/pdficon.png" alt="PDF File">';
                            } elseif ($fileExtension === 'doc' || $fileExtension === 'docx') {
                                echo '<img src="img/wordicon.png" alt="Word File">';
                            } else {
                                echo '<img src="uploads/'.$gas12hands1['image_url'].'" alt="Uploaded Image">';
                            }
                            ?>
                            <p><?php echo $gas12hands1['filename']; ?></p>
                            <a class="delete-btn" href="gas12hands1.php?delete_image=<?=$gas12hands1['image_url']?>">
                                <img src="img/remove.png" alt="Delete" width="1" height="1">
                            </a>
                            <a class="download-btn" href="uploads/<?=$gas12hands1['image_url']?>" download="<?=$gas12hands1['image_url']?>">
...
<script>
                ...
                xhttp.open("GET", "gas12hands1.php?mark_as_seen=" + encodeURIComponent(imageUrl), true);
                xhttp.send();
